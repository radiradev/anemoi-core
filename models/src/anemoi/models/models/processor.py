...
class AnemoiModelProc(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.emb_nodes_src = torch.nn.Linear(self.input_dim, self.num_channels)
    ...
    def forward(
        ...
        **kwargs
        ...
        x_data, x_skip, shard_shapes_data = self._assemble_input(x, batch_size, grid_shard_shapes, model_comm_group)
