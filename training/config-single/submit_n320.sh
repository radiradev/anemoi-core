...
#SBATCH --switches=1
#SBATCH --output=outputs/single.%j
...
#export ANEMOI_BASE_SEED=21216837  # mn5 ckpt seed 16017062
#export ANEMOI_BASE_SEED=16014177  # 22 leo ckpt seed 16014177
...
#srun anemoi-training train --config-name=single training.run_id=bb30dc7da0564ff2992a977014abd74e  # leo 22 ckpt
#srun anemoi-training train --config-name=single training.run_id=fc0f770f0d074c0089ef4274e9b75128  # mk5 ckpt
