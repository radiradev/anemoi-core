...
GITDIR=/perm/daep/projects/anemoi-core/feature-snow/training/configs-stable-diag
WORKDIR=$GITDIR
cd $WORKDIR
...
srun anemoi-training train --config-name=debug_o96-tend-roll hardware=slurm
