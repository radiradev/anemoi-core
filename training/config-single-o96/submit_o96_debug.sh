...
#srun anemoi-training train --config-name=single dataloader.limit_batches.training=100
srun anemoi-training train --config-name=single_snow dataloader.limit_batches.training=100
