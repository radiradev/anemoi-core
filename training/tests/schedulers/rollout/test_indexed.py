...
from anemoi.training.schedulers.rollout.indexed import PositionalIndexed, Lookup
...
def test_positional(rollouts: list[int], num_times_per_element: int, test_epoch: int, expected: int):
...
def test_lookup(rollouts: dict[int, int], test_epoch: int, expected: int):
