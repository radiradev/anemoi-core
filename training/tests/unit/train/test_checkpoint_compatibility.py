...
from anemoi.training.train.modify import TransferLearningModelModifier, WeightsInitModelModifier
...
class TestCheckpointCompatibility:
    ...
    def create_checkpoint(self, temp_dir: Path, model: nn.Module, filename: str = "test_checkpoint.ckpt", 
                         include_data_indices: bool = True, include_hyper_parameters: bool = True) -> Path:
    ...
    def test_exact_architecture_match(self):
    ...
    def test_partial_architecture_mismatch_transfer_learning(self):
    ...
    def test_major_architecture_mismatch(self):
    ...
    def test_checkpoint_missing_state_dict(self):
    ...
    def test_checkpoint_with_extra_layers(self):
    ...
    def test_checkpoint_with_missing_layers(self):
    ...
    def test_data_indices_compatibility(self):
    ...
    def test_checkpoint_without_data_indices(self):
    ...
    def test_checkpoint_without_hyper_parameters(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            source_model = TestModelArchitecture()
            checkpoint_path = self.create_checkpoint(temp_path, source_model, 
                                                   include_hyper_parameters=False)
...
class TestTransferLearningEdgeCases:
    ...
    def test_transfer_learning_function_error_handling(self, mock_transfer_loading):
...
class TestWeightsInitEdgeCases:
    ...
    def test_strict_loading_behavior(self):
    ...
    def test_checkpoint_path_types(self):
    ...
    def test_checkpoint_loading_flags(self):
