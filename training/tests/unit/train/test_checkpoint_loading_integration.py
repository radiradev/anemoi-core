...
class TestCheckpointLoadingIntegration:
    ...
    def test_no_checkpoint_loading_config(self):
    ...
    def test_checkpoint_loading_disabled(self):
    ...
    def test_checkpoint_loading_no_source(self):
    ...
    def test_weights_only_loading(self, mock_load_model):
    ...
    @patch('anemoi.training.train.test_checkpoint_loading_integration.load_model_from_checkpoint')
    def test_transfer_learning_loading(self, mock_load_model):
    ...
    @patch('anemoi.training.train.test_checkpoint_loading_integration.load_model_from_checkpoint')
    def test_standard_loading(self, mock_load_model):
    ...
    @patch('anemoi.training.train.test_checkpoint_loading_integration.load_model_from_checkpoint')
    def test_minimal_config(self, mock_load_model):
...
class TestTrainingPipelineIntegration:
    ...
    @patch('anemoi.training.train.test_checkpoint_loading_integration.load_model_from_checkpoint')
    def test_checkpoint_loading_before_model_modifiers(self, mock_load_model):
