...
"""
    cfg = OmegaConf.load( Path(__file__).parent / f"../../../src/anemoi/training/config/model/graphtransformer.yaml")
...
"""
    cfg = OmegaConf.load( Path(__file__).parent / f"../../../src/anemoi/training/config/model/graphtransformer_ens.yaml")
