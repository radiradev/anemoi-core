...
class TestModelModifierSchema:
    ...
    def test_schema_without_model_modifier(self):
    ...
    def test_schema_with_none_model_modifier(self):
    ...
    def test_schema_with_valid_model_modifier_dict(self):
    ...
    def test_schema_with_dictconfig_model_modifier(self):
        ...
        assert isinstance(schema.model_modifier, DictConfig) or isinstance(schema.model_modifier, dict)
    
    def test_schema_with_multiple_modifiers(self):
    ...
    def test_schema_with_empty_modifiers_list(self):
    ...
    def test_schema_preserves_arbitrary_modifier_configs(self):
    ...
    def test_schema_field_description(self):
    ...
    def test_schema_field_default_value(self):
    ...
    def test_schema_field_type_annotation(self):
    ...
    def test_schema_integration_with_other_fields(self):
...
class TestForecasterSchemaWithModelModifier:
    ...
    def test_forecaster_schema_with_model_modifier(self):
    ...
    def test_forecaster_ensemble_schema_with_model_modifier(self):
...
class TestModelModifierConfigValidation:
    ...
    def test_weights_init_modifier_config(self):
    ...
    def test_transfer_learning_modifier_config(self):
    ...
    def test_freezing_modifier_config(self):
    ...
    def test_combined_modifiers_config(self):
    ...
    def test_config_with_additional_parameters(self):
