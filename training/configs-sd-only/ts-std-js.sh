...
#SBATCH --output=slurm/aifs-std-tendency.out.%j
...
#srun anemoi-training train hardware=leonardo training.run_id=8e5004f9aa8e49ab8661b1370c8b4147 --config-name=debug_std-tendency-scale
srun anemoi-training train hardware=leonardo training.run_id=c49c7f5464f746f095163c7ce44b95fa --config-name=debug_std-tendency-scale
